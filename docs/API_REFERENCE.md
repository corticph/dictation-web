...
| `settingsEnabled`    | String[] | `settingsEnabled` | ✅       | `["device", "language"]` | ❌       | Which settings should be available in the UI. If empty, settings are disabled. Options: `"device"`, `"language"`. |
...
| Property        | Type    | Attribute | Writable | Default | Required | Description                                                                                                               |
| --------------- | ------- | --------- | -------- | ------- | -------- | ------------------------------------------------------------------------------------------------------------------------- |
| `settingsEnabled` | String[] | `settingsEnabled` | ✅       | `["device", "language"]` | ❌       | Which settings should be available. If empty array, menu is hidden. Options: `"device"`, `"language"`. |
...
- **Array attributes**: Use comma-separated values
  ```html
  <corti-dictation settingsEnabled="device,language"></corti-dictation>
